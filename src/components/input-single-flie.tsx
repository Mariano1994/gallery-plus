...
const InputSingleFile = ({size,form, error, ...props}:InputSingleFileProps) => {
  ...
  return(
    ...
    <div>
      ...
      <input type="file"  className="absolute top-0 right-0 h-full w-full opacity-0 cursor-pointer" {...props}/>
    ...
    {error && <Text variant="label-small" className="text-accent-red">
      ...
      <div className="flex flex-col ">
        ...
        <div className="flex">
          <button  onClick={()=> form.setValue(name, undefined)} type="button" 
